...
REM dev-gateway-build.bat
REM Build + npm link oca-gateway
REM Supports: Windows (cmd / PowerShell)
REM Usage: scripts\dev-gateway-build.bat

set "SCRIPT_DIR=%~dp0"
set "PROJECT_ROOT=%SCRIPT_DIR%.."
set "PKG_DIR=%PROJECT_ROOT%\gateway"
set "PKG_NAME=@oca/oca-gateway"
