...
REM dev-feishu-build.bat
REM Build + npm link oca-feishu
REM Supports: Windows (cmd / PowerShell)
REM Usage: scripts\dev-feishu-build.bat

set "SCRIPT_DIR=%~dp0"
set "PROJECT_ROOT=%SCRIPT_DIR%.."
set "PKG_DIR=%PROJECT_ROOT%\clients\feishu"
set "PKG_NAME=@oca/oca-feishu"
